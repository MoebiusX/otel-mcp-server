...
/*
 * Trade Integrity Circuit — Proof of Integrity™
 *
 ...
 * Private inputs: fillPrice, quantity, userId
 *
 * Guarantees:
 *   1. tradeHash == Poseidon(fillPrice, quantity, userId)
...
template TradeIntegrity() {
    ...
    //    tradeHash must equal Poseidon(fillPrice, quantity, userId)
